...
/*
os.Setenv("MEMBER_LIST_BIND_PORT", "1234")
os.Setenv("FRR_METRICS_PORT", "5678")
os.Setenv("FRR_HTTPS_METRICS_PORT", "0")
os.Setenv("METRICS_PORT", "9012")
os.Setenv("HTTPS_METRICS_PORT", "0")
os.Setenv("FRRK8S_FRR_METRICS_PORT", "3456")
os.Setenv("FRRK8s_HTTPS_METRICS_PORT", "7890")
os.Setenv("FRRK8S_FRR_HTTPS_METRICS_PORT", "2345")
os.Setenv("DEPLOY_PODMONITORS", "true")
os.Setenv("DEPLOY_SERVICEMONITORS", "true")*/
