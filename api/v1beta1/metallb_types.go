...
type MetalLBSpec struct {
	...
	// additional values to include in the announcedInterfacesToExclude list
	// +optional
	SpeakerAnnouncedInterfacesToExclude []string `json:"speakerAnnouncedInterfacesToExclude,omitempty"`
