...
func (in *BFDProfileSpec) DeepCopyInto(out *BFDProfileSpec) {
	*out = *in
	...
	if in.EchoReceiveInterval != nil {
		in, out := &in.EchoReceiveInterval, &out.EchoReceiveInterval
		*out = new(string)
		**out = **in
	}
	if in.EchoTransmitInterval != nil {
		in, out := &in.EchoTransmitInterval, &out.EchoTransmitInterval
		*out = new(uint32)
		**out = **in
	}
	if in.EchoMode != nil {
